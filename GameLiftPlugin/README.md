...
Amazon GameLift Servers Plugin for Unreal Engine is compatible with Unreal Engine 5 (versions 5.0, 5.1, 5.2, 5.3, 5.4, 5.5, 5.6, 5.7, and 5.8).  Use the plugin to develop and package game servers for Windows or Linux, and game clients for any Unreal-supported platform.
